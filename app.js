...
app.use('/assets', express.static(path.join(__dirname, '/bower_components/'), { maxAge: 31557600000 }));
...
app.get('/server/config', serverController.config);
app.post('/server/addQuestion', serverController.addQuestion);
